...
$(function(){
	//alert(1);
	var j = '{"id": 1,"name": "测试商品","price": 99.9,"detail": "测试商品描述","pic": "123456.jpg"}';
	$.ajax({
...
<body> 
	...
	<form id="itemForm"	action="${pageContext.request.contextPath }/uploadFile.action" method="post" enctype="multipart/form-data">
